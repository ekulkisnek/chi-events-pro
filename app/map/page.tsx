...
export default function MapPage() {
  ...
  useEffect(() => {
    ;(async () => {
      const ts = Date.now()
      // Try events.json first (generated by pipeline), then fallback to events.v4.json
      const urls = [
        `/data/events.json?v=${ts}`,
        `https://raw.githubusercontent.com/ekulkisnek/chi-events-pro/main/public/data/events.json?${ts}`,
        `/data/events.v4.json?v=${ts}`,
        `https://raw.githubusercontent.com/ekulkisnek/chi-events-pro/main/public/data/events.v4.json?${ts}`
      ]
